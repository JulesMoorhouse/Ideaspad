...
Friend Module Module1
    ...
    Sub Main()
        ...
        Dim oname As String
        Console.WriteLine()
        Console.WriteLine("The QND-Obfuscator, Copyright (c) 2002-2003 by Desaware Inc.")
    ...
    Sub DoTheObfuscate(ByVal inputfile As String, ByVal outputfile As String)
        Dim oktomangle As ArrayList
        Dim blockedinternal As Hashtable
        Dim blockedexternal As ArrayList
        ...
        mangler.RemovePrivateStrings(oktomangle)
        mangler.CollapsePrivateString()
        Try
    ...
    Sub DoOptions(ByVal opt As String)
        If Char.ToLower(opt.Chars(0)) = "h"c Then
            Console.WriteLine("QNDObfuscate infile outfile [-help]")
            Cancel = True
        End If
    End Sub
